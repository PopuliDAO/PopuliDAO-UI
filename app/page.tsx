        ...
        {partOfDAO ? (
          ...
          <>
            <div className="flex justify-center">
              {" "}
              <Card className="w-[800px] rounded-xl mt-10 bg-transparent border-none shadow-none">
                <CardHeader>
                  <CardTitle className="flex justify-center text-6xl">
                    PopuliDAO
                  </CardTitle>
                </CardHeader>
                <CardContent className="flex text-lg flex-col items-center justify-center">
                  The DAO platform for the people, by the people.
                </CardContent>
                <CardFooter className="flex text-sm justify-center">
                  Powered by WorldID, Built on Optimism.
                </CardFooter>
              </Card>
            </div>
